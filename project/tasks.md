...
- [x] Definir estrutura de domínio para Cliente e Endereço
- [x] Implementar validação de documento brasileiro (CPF/CNPJ)
- [x] Implementar criação de cliente via padrão Factory
- [x] Garantir limite de 60 caracteres para nome
- [x] Criar testes unitários para criação e validações de campos
- [x] Executar suíte de testes e validar critérios de aceitação
